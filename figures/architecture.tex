...
\node[procbox, below=10mm of rules] (rep) {\textbf{Report Generator}\\[2pt] merge profiles with\\ decisions, render audit\\ report and manuscript\\ artifacts};

% ---------- generated outputs (gray) ----------
\node[outbox, below=10mm of prof] (o1) {dataset profiles (CSV/JSON),\\ column inventory};
\node[outbox, below=10mm of eng] (o2) {decision, flags, actions\\ with rule trace};
\node[outbox, below=10mm of rep] (o3) {audit report, result tables,\\ \LaTeX{} macros};
